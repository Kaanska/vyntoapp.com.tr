...
// Shaders match the React component exactly
...
// Configuration matching your React component instance
const config = {
...
if (container) {
  ...
  const update = t => {
    ...
    // Matching React logic: program.uniforms.uTime.value = time * speed * 0.1;
    // where time defaults to t * 0.01
    const time = t * 0.01;
