 ...
 * Converted from React Bits implementation to vanilla JavaScript
 * Full physics-based fluid dynamics with velocity fields, pressure solving, and vorticity
 */
...
(function () {
    ...
    let gl, ext, supportLinearFiltering;
    ...
    function init() {
        ...
        const { gl: glContext, ext: extensions } = getWebGLContext(canvas);
        ext = extensions;
    ...
    let copyProgram, clearProgram, colorProgram, displayMaterial, splatProgram;
    ...
    function initShaders() {
        ...
        const blurVertShader = compileShader(gl.VERTEX_SHADER, blurVertexShader);

        copyProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, copyShader));
        clearProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, clearShader));
        colorProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, colorShader));
        splatProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, splatShader));
        advectionProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, advectionShader, ext.supportLinearFiltering ? null : ['MANUAL_FILTERING']));
        divergenceProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, divergenceShader));
        curlProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, curlShader));
        vorticityProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, vorticityShader));
        pressureProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, pressureShader));
        gradienSubtractProgram = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, gradientSubtractShader));

        displayMaterial = new GLProgram(vertexShader, compileShader(gl.FRAGMENT_SHADER, displayShaderSource, config.SHADING ? ['SHADING'] : null));
